...
/datum/round_event/zombie_infestation/announce(fake)
	priority_announce("Автоматизированные системы фильтрации воздуха выявили грибковый патоген 'РОМЕРОЛ' в вентиляционных системах станции, введён карантин.", "ВНИМАНИЕ: БИОЛОГИЧЕСКАЯ ОПАСНОСТЬ", 'sound/effects/siren-spooky.ogg', has_important_message = TRUE)
